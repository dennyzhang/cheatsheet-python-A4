...
ned = doIt(3, fun, 4, 9)
print (ned)
* [#A] Python Multi-Threading and Multi-Processing
...
* Python parse command arguemnt: argparse
...
#+END_EXAMPLE
* Python concurrency & Interoperability
** python run command
...
* DevOps choose language: Python vs Golang
